...
INSERT INTO CEFET_PRODUCAO.DBO.DimStatus (STATUS) VALUES ('Reprovado por média'),
('Aprovado'),
('Reprovado por falta'),
...
SELECT D.NOME_ALUNO, D.DATA_INI, B.DATA, C.NOME_MATERIA, A.NOTA_MATERIA, A.STATUS_MATERIA, E.STATUS, C.HORA_AULA FROM
